...
# Removed background execution, PID saving, sleep, verification, and tail -f logic

echo "Backend process stopped." # This will only be reached if npm run start:dev exits
